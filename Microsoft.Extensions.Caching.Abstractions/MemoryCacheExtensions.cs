...
namespace Microsoft.Extensions.Caching.Memory
{
    public static class CacheExtensions
    {
        ...
        public static TItem Set<TItem>(this IMemoryCache cache, object key, TItem value, IDropOutToken dropOutToken = null)
        {
        ...
        public static TItem GetOrCreate<TItem>(this IMemoryCache cache, object key, Func<ICacheEntry, TItem> factory, IDropOutToken dropOutToken = null)
        {
            object result;
            if (!cache.TryGetValue(key, out result))
            {
