...
namespace Microsoft.Extensions.Caching.Memory
{
    internal class CacheEntry : ICacheEntry
    {
        ...
        /// <summary>
        /// Gets or sets a token to force memory pressure triggered cleanup to drop out the cache entry before entry lifetime. />.
        /// </summary>
        public IDropOutToken DropOutToken { get; set; }    
        ...
        {
            return _isExpired || CheckForExpiredTime(now) || CheckForExpiredTokens() || ((DropOutToken != null) && DropOutToken.DropOutRequest);
        }
